...
1. requires _nodejs@^0.12_ ([download here](https://nodejs.org/download/)) and [_gulp_](https://github.com/gulpjs/gulp/blob/master/) (run `npm install gulp -g` after installing node)
